...
- 2026-08-02: 原作8キャラの必殺技14効果を実装。手動17入力経路とPIYO自動派生、
  特殊軌道、状態異常、CPU、表示、snapshot、probe、全リセットを接続した。
- 正規検証は699 tests、0 failed、SCRIPT ERROR 0。人間の試遊感だけ未確認。
- 完了仕様は`docs/superpowers/specs/2026-08-02-original-character-special-moves-design.md`。
- 完了仕様はLF行数488、SHA-256
  `ada48c5c4326105b9fb22aa9b0770597134279d49fbd9cf48252cbb1a474869a`。
- #103は必殺技部分を完了し、打ち分け例外と固有の癖だけを残す。
